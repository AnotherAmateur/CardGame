...
public partial class Protagonist : Player
{
    ...
    public new void DoPass() => base.DoPass();

    public bool PutCardFromHandOnBoard(CardDB.CardData cardInfo)
    {
    ...
    public void TakeCardsFromDeck(List<int> cards)
    {
        ...
        UpdateHand();
        GFieldController.Instance.UpdateDeckSize();
    }
    ...
    public void UpdateHand()
    {
        ...
        for (int i = 0; i < this.Hand.Count; i++)
        {
            ...
            card.SetParams(cardSize, CardDB.GetCardTexturePath(cardId),
                CardDB.GetCardInfo(cardId));
